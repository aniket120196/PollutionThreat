    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="cloud.jsp"><span>UPLOAD DETAILS</span></a></li>
        ...
        <!--<a href="#"><img src="images/image.jpg" width="960" height="360"  /></a>--> 
         <!--<div class="slider">-->
            <center>
              ...
              <table border="2px">
                  <tr><th style="color: black">S.No</th><th style="color: black">Username</th><th style="color: black">File Name</th><th style="color: black">File Path</th> <th style="color: black">Checksum</th><th style="color: black">Status</th></tr>
                  <%
...
//                              String key=rs.getString("key1");
                               String check=rs.getString("checksum");
                  ...
                  <input type="text" name="ch" value="<%=check%>" hidden="">
                   <input type="text" name="fil" value="<%=filepath%>" hidden="">
                        <input type="text" name="filename" value="<%=filename%>" hidden="">
                        <input type="text" name="sno" value="<%=sno%>" hidden="">
                       <tr><td style="color: black"><%=sno%></td><td style="color: black"><%=user%></td><td style="color: black"><%=filename%></td><td style="color: black"><%=filepath%></td><td style="color: black"><input type="text" name="check" value="<%=check%>"></td><td><input type="submit" value="submit"></td></tr> 
