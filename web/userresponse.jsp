...
-->      <li class="active" ><a href="userresponse.jsp"><span>ACCEPT RESPONSE</span></a></li>
      ...
      <div class="slider">
        ...
        <!--<a href="#"><img src="images/image.jpg" width="960" height="360"  /></a>--> 
         <!--<div class="slider">-->
            <center>
              <table border="2px">
                  <tr><th style="color: black"> S.No</th><th style="color: black">User Name</th><th style="color: black">File Name</th><th style="color: black">Key</th><th style="color: black">Send</th></tr>
        <% 
            ...
            try{
                ...
                String sa="Select * from imm where status='request'";
            ...
            %>
            <form action="adminaccept" method="post">
                <!--<input type="text" name="kye" hidden="">-->
                <input type="text" name="sno" value="<%=sno%>" hidden="">
                
                <tr id="da"><td><%=sno%></td><td><%=username%></td><td><%=filename%></td><td><input type="text" name="key" value="<%=key%>"></td><td><input type="submit" value="Accept" style="background-color: blue"></td></tr>
            </form>
            <%
             } } 
