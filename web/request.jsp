    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="request.jsp"><span>REQUEST</span></a></li>
      ...
      <div class="slider">
        ...
        <!--<a href="#"><img src="images/image.jpg" width="960" height="360"  /></a>--> 
         ...
         <center>
              <table border="2px">
                  <tr><th style="color: black">S.No</th><th style="color: black">Username</th><th style="color: black">File Name</th><th style="color: black">File Path</th><th style="color: black">Key</th><th style="color: black">Status</th></tr>
                  <%
...
//                              String filecontent=rs.getString(5);
                  ...
                  <form action="request" method="post"> 
                     ...
                     <!--<input type="text" name="sno" value="<%=sno%>" hidden="">-->
                         
                  <tr><td style="color: black"><%=sno%></td><td style="color: black"><%=user%></td><td style="color: black"><%=filename%></td><td style="color: black"><%=filepath%></td><td style="color: black"> <input type="text" name="key" value="<%=key%>"></td>
                   <%
                    if(rs.getString("status").equals("upload"))
                    {
                    
                    %>
                    <td><input type="submit" value="request" style="background-color: greenyellow;" enabled></td>
                    <%
                    ...
                    {
                        %>
                    <td><input type="submit" value="request" style="background-color: red" disabled></td>
                    <%
                    }
                    %></tr></form>
