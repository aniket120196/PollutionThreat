...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
              <li  ><a href="auhome.jsp"><span>HOME</span></a></li>
          
          <!--<li><a href="cloud.jsp"><span>UPLOAD DETAILS</span></a></li>-->
          <li class="active"><a href="audetails.jsp"><span>USER DETAILS</span></a></li>
      
<!--<li><a href="userresponse.jsp"><span>ACCEPT RESPONSE</span></a></li>-->
         <!--<li><a href="status.jsp"><span>STATUS</span></a></li>-->
          <li><a href="AUTHORITY.jsp"><span>LOGUT</span></a></li>   
     </div>
     ...
     <center>
        <!--<div style="margin-top: 100px">-->
            ...
            <tr><th style="color: black">username</th><th style="color: black">filename</th><th style="color: black"> key</th><th style="color: black">status</th></tr>
...
//                      String fc=rs.getString("filecontent");
                    String fp=rs.getString("key1");
                     ...
                     %>
                         ...
                         <input type="text" name="clo" value="<%=fp%>" hidden="">
                             <tr><td style="color: black"><%=naa%></td><td style="color: black"><%=fn%></td><td style="color: black"><%=fp%></td><td style="color: black"><%=status%></td></tr>
            ...
            <form method="post" action="down">
                <input type="text" name="name"  placeholder="Enter File Name"></input>
