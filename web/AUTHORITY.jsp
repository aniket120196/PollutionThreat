    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li class="active" ><a href="AUTHORITY.jsp"><span>AUTHORITY</span></a></li>
        </ul>
      </div>
      ...
      <div class="slider">
       ...
       <tr><td style="color:white" >User Name</td><td><input type="text" name="name"/></td> </tr>
        <tr><td style="color:white">Password</td><td><input type="password" name="pass"  /></td></tr>
        <tr><td style="color:white"></td><td><input type="submit" value="Login" /></td></tr>
